...
const breadcrumbs = (brand: CarBrand): BreadcrumbItem[] => [
    ...
    {
        title: 'Edit',
        href: `/admin/car-brands/${brand.id}/edit`,
    },
];

export default function AdminCarBrandsEdit({ brand }: { brand: CarBrand }) {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Update {brand.name}'s information
                        </p>
                    </div>
                </div>
